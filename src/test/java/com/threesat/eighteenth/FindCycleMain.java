package com.threesat.eighteenth;
...
public class FindCycleMain {
	...
	public FindCycleMain() throws Exception {
		...
		System.out.println(findZeroClauses(expression));
	}
	
	private List<Clause> findZeroClauses(List<Clause> expression) {
		List<Clause> zeros = new LinkedList<Clause>();
	...
	class Match {
		...
		List<Clause> used = null;
		List<Clause> expression = null;
		Assignments assig = null;
		
		public Match(Clause c, List<Clause> expression) {
			this.expression = expression;
			used = new ArrayList<>();
			assig = new Assignments(c.getVariables());
		}
